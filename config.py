...
COHERE_MAX_RETRIES = _env_int("COHERE_MAX_RETRIES", 5)
COHERE_BACKOFF_INITIAL_SECONDS = _env_float("COHERE_BACKOFF_INITIAL_SECONDS", 5.0)
COHERE_BACKOFF_MAX_SECONDS = _env_float("COHERE_BACKOFF_MAX_SECONDS", 60.0)
