...
from config import NAIVE_COLLECTION, NAIVE_REPORT_PATH, DEFAULT_CONTEXT_TOP_K, EVAL_METRICS
...
def main():
    ...
    for item in test_set:
        results = search.search(item["question"], top_k=DEFAULT_CONTEXT_TOP_K, collection=NAIVE_COLLECTION)
    ...
    save_report(results, [], path=NAIVE_REPORT_PATH)
